...
class Connection(specbase.Class):
    INDEX = 0x000A ## 10
    NAME = 'Connection'

    class Start(specbase.Method):
        ...
        def decode(self, encoded, offset = 0):
            ...
            offset = offset + 1
            (self.server_properties, offset) = table.decode_table(encoded, offset)
        ...
        def encode(self):
            ...
            table.encode_table(pieces, self.server_properties)
    ...
    class StartOk(specbase.Method):
        ...
        def decode(self, encoded, offset = 0):
            (self.client_properties, offset) = table.decode_table(encoded, offset)
        ...
        def encode(self):
            pieces = []
            table.encode_table(pieces, self.client_properties)
    ...
    class SecureOk(specbase.Method):
    ...
    class Redirect(specbase.Method):
...
class Channel(specbase.Class):
    ...
    class Alert(specbase.Method):
        ...
        def decode(self, encoded, offset = 0):
            ...
            self.reply_text = encoded[offset : offset + length]
            offset = offset + length
            (self.details, offset) = table.decode_table(encoded, offset)
            return self
        ...
        def encode(self):
            ...
            pieces.append(struct.pack('B', len(self.reply_text)))
            pieces.append(self.reply_text)
            table.encode_table(pieces, self.details)
            return pieces
...
class Access(specbase.Class):
    INDEX = 0x001E ## 30
    NAME = 'Access'

    class Request(specbase.Method):
    ...
    class RequestOk(specbase.Method):
...
class Exchange(specbase.Class):
    INDEX = 0x0028 ## 40
    NAME = 'Exchange'

    class Declare(specbase.Method):
        ...
        def decode(self, encoded, offset = 0):
            ...
            (self.arguments, offset) = table.decode_table(encoded, offset)
            return self
        ...
        def encode(self):
            ...
            pieces.append(struct.pack('B', bit_buffer))
            table.encode_table(pieces, self.arguments)
            return pieces

    class DeclareOk(specbase.Method):
    ...
    class DeleteOk(specbase.Method):
...
class Queue(specbase.Class):
    ...
    class UnbindOk(specbase.Method):
...
class Basic(specbase.Class):
    INDEX = 0x003C ## 60
    NAME = 'Basic'

    class Qos(specbase.Method):
    ...
    class ConsumeOk(specbase.Method):
    ...
    class CancelOk(specbase.Method):
    ...
    class GetEmpty(specbase.Method):
    ...
    class RecoverAsync(specbase.Method):
    ...
    class RecoverOk(specbase.Method):
...
class Tx(specbase.Class):
    INDEX = 0x005A ## 90
    NAME = 'Tx'

    class Select(specbase.Method):
    ...
    class SelectOk(specbase.Method):
    ...
    class CommitOk(specbase.Method):
    ...
    class Rollback(specbase.Method):
    ...
    class RollbackOk(specbase.Method):
...
class Tunnel(specbase.Class):
    ...
    class Request(specbase.Method):
        ...
        def decode(self, encoded, offset = 0):
            (self.meta_data, offset) = table.decode_table(encoded, offset)
            return self

        def encode(self):
            pieces = []
            table.encode_table(pieces, self.meta_data)
            return pieces

class Test(specbase.Class):
    INDEX = 0x0078 ## 120
    NAME = 'Test'

    class Integer(specbase.Method):
    ...
    class IntegerOk(specbase.Method):
    ...
    class StringOk(specbase.Method):
    ...
    class Table(specbase.Method):
        ...
        def decode(self, encoded, offset = 0):
            (self.table, offset) = table.decode_table(encoded, offset)
    ...
    class ContentOk(specbase.Method):
...
class BasicProperties(specbase.Properties):
    CLASS = Basic
    INDEX = 0x003C ## 60
    ...
    def decode(self, encoded, offset = 0):
        ...
        if (flags & BasicProperties.FLAG_HEADERS):
            (self.headers, offset) = table.decode_table(encoded, offset)
        else:
            self.headers = None
    ...
    def encode(self):
        ...
        if self.headers is not None:
            ...
            table.encode_table(pieces, self.headers)
...
class FileProperties(specbase.Properties):
    CLASS = File
    INDEX = 0x0046 ## 70
    NAME = 'FileProperties'
    FLAG_CONTENT_TYPE = (1 << 15)
...
class StreamProperties(specbase.Properties):
    CLASS = Stream
    INDEX = 0x0050 ## 80
...
class TunnelProperties(specbase.Properties):
    CLASS = Tunnel
    INDEX = 0x006E ## 110
